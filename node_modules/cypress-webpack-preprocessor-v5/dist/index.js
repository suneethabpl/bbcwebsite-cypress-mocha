    ...
    return function (file) {
        ...
        var webpackOptions = _
            ...
            if (opts.devtool === false) {
                ...
                typescript_overrides_1.overrideSourceMaps(false);
                return;
            }
            ...
            // proper source maps
            typescript_overrides_1.overrideSourceMaps(true);
        })
            .value();
        ...
        var latestBundle = deferred_1.createDeferred();
        ...
        var onCompile = function () {
            ...
            latestBundle = deferred_1.createDeferred();
